...
function findStation(){
	...
	location.href="findstation2?input="+string;
}

 $(document).on("click", "#select", function(e){
	
	opener.document.all.resultStationCode2.value = $(this).attr("data-stationCode");
	opener.document.all.resultStationName2.value = $(this).attr("data-stationName");
	window.close();
});
